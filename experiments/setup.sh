...
./henry-prioritization-runner.sh $SUBJ_NAME $DT_SUBJ $DT_TOOLS_DIR $DT_LIBS_DIR $DT_TESTS $DT_CLASS $PRIO_RESULTS
...
#java -cp $DT_TOOLS:$NEW_DT_LIBS:$NEW_DT_CLASS:$DT_TESTS:$JAVA_HOME/jre/lib/*: edu.washington.cs.dt.impact.Main.InstrumentationMain -inputDir $DT_TESTS -technique selection #change DT_TESTS?

#run instrumented tests for new human written tests
#i don't think this is necessary
#java -cp $DT_TOOLS:$NEW_DT_LIBS:$NEW_DT_SUBJ/sootOutput/: edu.washington.cs.dt.main.ImpactMain -inputTests $DT_SUBJ/$SUBJ_NAME-orig-order
#mv sootTestOutput/ sootTestOutput-orig-selection
#rm -rf sootOutput/
...
#run instrumented tests for new auto tests
#i don't think this is necessary
#java -cp $DT_TOOLS:$NEW_DT_LIBS:$NEW_DT_SUBJ/sootOutput/: edu.washington.cs.dt.main.ImpactMain -inputTests $DT_SUBJ/$SUBJ_NAME-auto-order
#mv sootTestOutput/ sootTestOutput-auto-selection
#rm -rf sootOutput/

#cd ..
#./henry-selection-runner.sh $SUBJ_NAME $NEW_DT_SUBJ $DT_TOOLS_DIR $NEW_DT_LIBS_DIR $DT_TESTS $NEW_DT_CLASS $SELE_RESULTS $DT_SUBJ
...
#./henry-parallelization-runner.sh $SUBJ_NAME $DT_SUBJ $DT_TOOLS_DIR $DT_LIBS_DIR $DT_TESTS $DT_CLASS $PARA_RESULTS