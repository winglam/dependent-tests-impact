...
export DT_SUBJ_ROOT=/home/user/dependent-tests-impact/experiments/jodatime-b609d7d66d

# The root directory for the new subject
export NEW_DT_SUBJ_ROOT=/home/user/dependent-tests-impact/experiments/jodatime-d6791cb5f9
