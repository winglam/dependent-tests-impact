...
export DT_SUBJ_ROOT=/home/user/dependent-tests-impact/experiments/zeppelin/zeppelin-zengine
...
export NEW_DT_SUBJ_ROOT=/home/user/dependent-tests-impact/experiments/zeppelin-zengine-new/zeppelin-zengine
...
export SUBJ_NAME=zeppelin-zengine
