...
java -ea -cp $DT_LIBS:$DT_CLASS:/home/user/dependent-tests-impact/experiments/impact-tools/randoop-all-3.0.8.jar: randoop.main.Main gentests --classlist=$SUBJ_NAME-classes --outputlimit=5000 --ignore-flaky-tests=true
...
java -cp $DT_TOOLS:$DT_LIBS:$DT_CLASS:$DT_RANDOOP: edu.washington.cs.dt.impact.Main.InstrumentationMain -inputDir $DT_RANDOOP
java -cp $DT_TOOLS:$DT_LIBS:$DT_CLASS: edu.washington.cs.dt.impact.Main.InstrumentationMain -inputDir $DT_CLASS
