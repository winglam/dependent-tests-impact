...
cd dynoptic
java -cp impact-tools/*:bin/:../synoptic/lib/*:../synoptic/bin/:../daikonizer/bin/ edu.washington.cs.dt.impact.Main.MainDriver -inputDir bin -technique selection
cd ../dynoptic-ea407ba0a750
java -cp impact-tools/*:bin/:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.impact.Main.MainDriver -inputDir bin -technique selection
cd ..
...
java -cp impact-tools/*:sootOutput:../synoptic/lib/*:../synoptic/bin/:../daikonizer/bin/ edu.washington.cs.dt.main.ImpactMain ../dynoptic-ea407ba0a750/synoptic-auto-order
cd ..
...
cd dynoptic-ea407ba0a750
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-ts-function-orig-order.txt > synoptic-ts-function-orig-order-results.txt
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-ts-function-absolute.txt > synoptic-ts-function-absolute-results.txt
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-ts-function-random.txt > synoptic-ts-function-random-results.txt
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-ts-function-relative.txt > synoptic-ts-function-relative-results.txt
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-ts-statement-relative.txt > synoptic-ts-statement-relative-results.txt
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-ts-statement-random.txt > synoptic-ts-statement-random-results.txt
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-ts-statement-orig-order.txt > synoptic-ts-statement-orig-order-results.txt
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-ts-statement-absolute.txt > synoptic-ts-statement-absolute-results.txt

#java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-orig-order > synoptic-orig-order-results.txt
java -cp impact-tools/*:bin:../synoptic/lib/*:../synoptic-ea407ba0a750/bin/:../daikonizer-ea407ba0a750/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-auto-order > synoptic-orig-order-results.txt
