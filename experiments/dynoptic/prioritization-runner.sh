...
java -cp impact-tools/*:bin/:../synoptic/lib/*:../synoptic/bin/:../daikonizer/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-tp-statement-absolute.txt > synoptic-tp-statement-absolute-results.txt
...
java -cp impact-tools/*:bin/:../synoptic/lib/*:../synoptic/bin/:../daikonizer/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-tp-statement-relative.txt > synoptic-tp-statement-relative-results.txt
...
java -cp impact-tools/*:bin/:../synoptic/lib/*:../synoptic/bin/:../daikonizer/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-tp-function-absolute.txt > synoptic-tp-function-absolute-results.txt
...
java -cp impact-tools/*:bin/:../synoptic/lib/*:../synoptic/bin/:../daikonizer/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-tp-function-relative.txt > synoptic-tp-function-relative-results.txt
...
java -cp impact-tools/*:bin/:../synoptic/lib/*:../synoptic/bin/:../daikonizer/bin/ edu.washington.cs.dt.main.ImpactMain synoptic-random.txt > synoptic-random-results.txt
